  ...
  return (
    <Container maxWidth="lg" sx={{ mt: 4, mb: 4 }}>
      ...
      <Grid container spacing={3}>
        ...
        <Grid item xs={12} md={6}>
          <Paper sx={{ p: 3, backgroundColor: 'white', borderRadius: 2 }}>
            <Typography variant="h6" sx={{ mb: 2, fontWeight: 'bold' }}>Add Transaction</Typography>
            <Box component="form" onSubmit={handleSubmit} sx={{ mt: 2 }}>
              ...
              <FormControl fullWidth sx={{ mb: 2 }}>
                <Select
                  ...
                  renderValue={(selected) => selected ? selected.charAt(0).toUpperCase() + selected.slice(1) : "Select type"}
